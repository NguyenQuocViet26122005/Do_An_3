...
const SinhVienProfile: React.FC = () => {
  const { user } = useAuth();
    ...
    <div>
      ...
      <Card>
        <Descriptions bordered column={1}>
          ...
          <Descriptions.Item label="Vai trò"><Tag color="green">Sinh viên</Tag></Descriptions.Item>
          ...
          <Descriptions.Item label="Mã sinh viên">{user?.maActorCode}</Descriptions.Item>
        </Descriptions>
      </Card>
    </div>
  );
...
export default SinhVienProfile;
